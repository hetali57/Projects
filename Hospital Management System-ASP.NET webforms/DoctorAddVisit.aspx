<%@ Page Title="" Language="C#" MasterPageFile="~/Site4.Master" AutoEventWireup="true" CodeBehind="DoctorAddVisit.aspx.cs" Inherits="Hospital_Management_System_Ass.DoctorAddVisit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
      ...
      <div class ="col-sm-6">
          <asp:TextBox ID="txtDrName" CssClass="form-control" runat="server"></asp:TextBox><br />
            </div>
        </div>
     ...
     <div class="form-group">
        <div class="col-sm-offset-5 col-md-6">
          <asp:Button ID="btnDelete" CssClass="btn btn-danger" runat="server" Text="Delete Profile" OnClick="btnDelete_Click"/>
         ...
         <asp:Button ID="btnAdd" CssClass="btn btn-danger" runat="server" Text="Add Profile" OnClick="btnAdd_Click"/>

                <br /><asp:Label ID="lblDetail" runat="server" Text=""></asp:Label>
          </div>
         </div>
</asp:Content>
